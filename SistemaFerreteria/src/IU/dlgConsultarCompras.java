...
public class dlgConsultarCompras extends javax.swing.JDialog {
    ...
    public dlgConsultarCompras(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cabe.consCompras(jTable1);
        cabe.consDetalleCompras(jTable2);

        controlCompra.listarCompras(jTable1);
    }
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/No-entry.png"))); // NOI18N
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            controlCompra.listarDetalleCompras(jTable2);
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        try {
            int rpta = Mensajes.confirmar("Desea Anular esta Compra");
            if (rpta == 0) {
                controlCompra.anularCompra();
