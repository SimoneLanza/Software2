...
public class dlgConSalidas extends javax.swing.JDialog {
    ...
    public dlgConSalidas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        cabe.consultaSalidas(jTable1);
        cabe.detalleSalidas(jTable2);
        controlSalida.listSalidas(jTable1);
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            controlSalida.listDetalle(jTable2);
        } catch (Exception e) {
